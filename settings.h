...
extern unsigned long marcheForceeTemporisation; // temporisation de la marche forcée par défaut 1h
extern float intensiteDC;     // mesure de la pince à effet hall
